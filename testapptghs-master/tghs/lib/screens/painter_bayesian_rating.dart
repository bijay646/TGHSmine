...
class PainterBayesianScreen extends StatefulWidget {
  static const String id = 'painter_bayesian_rating';

  @override
  _PainterBayesianScreenState createState() => _PainterBayesianScreenState();
}

class _PainterBayesianScreenState extends State<PainterBayesianScreen> {
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          ...
          RaisedButton(
            onPressed: () async {
              ...
              Navigator.pushNamedAndRemoveUntil(context, FinalPainterRatingScreen.id, (r) => false,
                  arguments: wid);
            },
            child: Text('Ok'),
          )
    ...
    //       Navigator.pushNamed(context, FinalPainterRatingScreen.id,
    //           arguments: wid);
    //     }
    //   ),
    // );
